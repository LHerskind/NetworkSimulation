...
public class BeamNode extends Thread{

    private String name;
    private int id;

    private ArrayList<BeamNode> peers = new ArrayList<BeamNode>();
    ...
    private BeamNode stem_node = null;
    ...
    public void addPeer(BeamNode peer){
        this.peers.add(peer);
    }

    public ArrayList<BeamNode> getPeers(){
        return this.peers;
    }
    ...
    private void unicast(Message message, BeamNode peer){
